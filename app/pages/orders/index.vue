...
const { fetchOrders, deleteOrder } = useAdminOrder()
// composables/admin/useOrder.ts (nanti disiapkan untuk API konsumsi)
...
const handleConfirmDelete = async () => {
  if (orderToDelete.value !== null) {
    ...
    try {
      const response = await deleteOrder(orderToDelete.value)
